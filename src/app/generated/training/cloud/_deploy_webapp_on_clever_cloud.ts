...
<div class="content">
<pre class="highlight"><code class="language-java" id="1724055769142.5786">{
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769142.5786')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
