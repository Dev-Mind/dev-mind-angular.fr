...
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687253.4646"><span class="hljs-keyword">public</span> <span class="hljs-keyword">interface</span> <span class="hljs-title class_">FriendService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687253.4646')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687253.9856"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">FriendServiceImpl</span> <span class="hljs-keyword">implements</span> <span class="hljs-title class_">FriendService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687253.9856')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687253.6558"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">FriendServiceImpl</span> <span class="hljs-keyword">implements</span> <span class="hljs-title class_">FriendService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687253.6558')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687254.5293"><span class="hljs-keyword">package</span> com.devmind.unitests.friend;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687254.5293')">Copy</button></pre>
</div>
</div>
<div class="olist arabic">
<ol class="arabic">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687254.5676">Assertions.assertThat(age).isEqualTo(<span class="hljs-number">45</span>);
Assertions.assertThat(name).isEqualTo(<span class="hljs-string">&quot;Bellamy&quot;</span>);</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687254.5676')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687255.7544">Assertions.assertThatThrownBy(() <span class="hljs-meta">@LAMBDA</span> friendService.computeFriendAge(<span class="hljs-literal">null</span>))
                .isExactlyInstanceOf(IllegalArgumentException.class)
                .hasMessage(<span class="hljs-string">&quot;Friend is required&quot;</span>);</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687255.7544')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687255.638">List<span class="hljs-meta">@LTFriend</span><span class="hljs-meta">@GT</span> myFriends = Arrays.asList(
                ...
                <span class="hljs-keyword">new</span> <span class="hljs-title class_">Friend</span>(<span class="hljs-string">&quot;Charles&quot;</span>, <span class="hljs-number">2001</span>));</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687255.638')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687255.3628">Assertions.assertThat(myFriends)
...
Assertions.assertThat(myFriends)
          ...
          .containsExactlyInAnyOrder(
                  ...
                  Tuple.tuple(<span class="hljs-string">&quot;Charles&quot;</span>, <span class="hljs-number">2001</span>));</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687255.3628')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687255.3657"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">FriendServiceImpl</span> <span class="hljs-keyword">implements</span> <span class="hljs-title class_">FriendService</span> {
    ...
    <span class="hljs-comment">// ...</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687255.3657')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687256.768"><span class="hljs-meta">@ExtendWith(MockitoExtension.class)</span> <span class="hljs-comment">// 1.</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687256.768')">Copy</button></pre>
</div>
</div>
<div style="page-break-after: always;"></div>
<div class="olist arabic">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687256.2249">Mockito.when(friendRepository.findAll()).thenThrow(<span class="hljs-keyword">new</span> <span class="hljs-title class_">IllegalArgumentException</span>(<span class="hljs-string">&quot;Error&quot;</span>));</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687256.2249')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1723541687256.6992">git clone https://github.com/Dev-Mind/unitTestInAction.git</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687256.6992')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1723541687256.167">git clone git@github.com:Dev-Mind/unitTestInAction.git</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687256.167')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541687256.5112">dependencies {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687256.5112')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
