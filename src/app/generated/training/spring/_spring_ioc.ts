...
<ul class="sectlevel1">
<li><a href="@link@#_objects_and_application">Objects and application</a></li>
<li><a href="@link@#_inversion_of_control_ioc_principle">Inversion of Control (IOC) Principle</a></li>
<li><a href="@link@#_spring_beans">Spring Beans</a>
<ul class="sectlevel2">
<li><a href="@link@#_create_a_bean">Create a bean</a></li>
<li><a href="@link@#_add_dependencies">Add dependencies</a></li>
<li><a href="@link@#_how_it_works">How it works ?</a></li>
</ul>
</li>
<li><a href="@link@#_flask_using_dependency_injection"><span class="icon">[flask&#93;</span> Using Dependency Injection</a>
<ul class="sectlevel2">
<li><a href="@link@#_create_a_first_bean">Create a first bean</a></li>
<li><a href="@link@#_inject_your_bean">Inject your bean</a></li>
<li><a href="@link@#_inject_your_bean_in_configuration_bean">Inject your bean in configuration bean</a></li>
<li><a href="@link@#_other_cases">Other cases</a></li>
</ul>
</li>
...
<div class="content">
<pre class="highlight"><code class="language-java"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">NameService</span> {
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">WelcomeService</span> {
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">B</span> {
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java"><span class="hljs-keyword">package</span> com.emse.spring.automacorp.hello;
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell">2023-08-23T19:59:02.183+02:00  INFO 152677 --- [  restartedMain] o.s.b.d.a.OptionalLiveReloadServer       : LiveReload server is running on port 35729
