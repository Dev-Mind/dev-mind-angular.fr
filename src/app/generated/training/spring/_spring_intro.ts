...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435671.1277">rootProject.name = <span class="hljs-string">&quot;automacorp&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435671.1277')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435671.9294">plugins {
...
tasks.<span class="hljs-symbol">withType@</span><span class="hljs-symbol">LTTest@</span>GT { <span class="hljs-comment">// (11)</span>
	useJUnitPlatform()
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435671.9294')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435671.993"><span class="hljs-keyword">package</span> com.emse.spring.automacorp;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435671.993')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435671.6057"><span class="hljs-meta">@SpringBootTest</span> <span class="hljs-comment">// (2)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435671.6057')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1755673435672.7532">./gradlew --continuous bootRun // (1)
...
&lt;==========---&gt; 80% EXECUTING
<span class="hljs-meta prompt_">&gt; </span><span class="language-bash">:bootRun  // (2)&lt;/==========---&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.7532')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1755673435672.098">***************************
...
Identify and stop the process that&#x27;s listening on port 8080 or configure this application to listen on another port.</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.098')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-properties" id="1755673435672.3289"><span class="hljs-attr">server.port</span>=<span class="hljs-string">8085</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.3289')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1755673435672.2705">./gradlew assemble</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.2705')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1755673435672.3926">java -jar build/libs/automacorp-0.0.1-SNAPSHOT.jar</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.3926')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435672.4932"><span class="hljs-keyword">public</span> <span class="hljs-keyword">static</span> <span class="hljs-keyword">void</span> <span class="hljs-title function_">main</span><span class="hljs-params">(String[] args)</span> { }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435672.4932')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1755673435678.9634"><span class="hljs-tag">&lt;<span class="hljs-name">html</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
        Hello world
    <span class="hljs-tag">&lt;/<span class="hljs-name">body</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435678.9634')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1755673435678.5159"><span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">href</span>=<span class="hljs-string">&quot;https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css&quot;</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">&quot;stylesheet&quot;</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">&quot;sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH&quot;</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">&quot;anonymous&quot;</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435678.5159')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1755673435678.762"><span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">body</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435678.762')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435678.095">dependencies {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435678.095')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
