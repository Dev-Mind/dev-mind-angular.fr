...
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.8926">sudo yum install git</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.8926')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.8726">sudo apt-get install git</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.8726')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.89">~@dollar@ git --version

git version 2.34.1</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.89')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.5176">~@dollar@ git config --global user.name &quot;Guillaume EHRET Dev-Mind&quot;
~@dollar@ git config --global user.email &quot;guillaume@dev-mind.fr&quot;</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.5176')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.7605">~@dollar@  git config --global init.defaultBranch main</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.7605')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.2402">~@dollar@ git clone https://github.com/Dev-Mind/git-demo.git</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.2402')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.5342">~@dollar@ cd git-demo
~@dollar@ git log</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.5342')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.9612">~@dollar@ cd ..
~@dollar@ rm -rf git-demo
~@dollar@ mkdir git-demo
~@dollar@ cd git-demo</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.9612')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738126.5044">~@dollar@ git init

Initialized empty Git repository in /home/devmind/Workspace/java/git-demo/.git/</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738126.5044')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.035">---
~@dollar@ ls -la
total 28
...
----</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.035')">Copy</button></pre>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.9094">~@dollar@ echo &quot;Hello world&quot; @GT hello.txt
...
~@dollar@ ls
hello.html  hello.txt  hello.md</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.9094')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.0024">~@dollar@ git status
...
nothing added to commit but untracked files present (use &quot;git add&quot; to track)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.0024')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.0493">~@dollar@ git add hello.txt
~@dollar@ git add .</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.0493')">Copy</button></pre>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.1582">~@dollar@ git status
...
Changes to be committed:
  (use &quot;git rm --cached @LTfile@GT...&quot; to unstage)
	new file:   hello.html
	new file:   hello.md
	new file:   hello.txt</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.1582')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.3848">~@dollar@ git commit -m &quot;First commit&quot;

[main a7d5b84] First commit
 3 files changed, 3 insertions(+)
 create mode 100644 hello.html
 create mode 100644 hello.md
 create mode 100644 hello.txt</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.3848')">Copy</button></pre>
</div>
</div>
<div class="olist arabic">
<ol class="arabic">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.705">~@dollar@ rm hello.md
~@dollar@ echo &quot;My first Git example&quot; &gt; hello.md
~@dollar@ echo &quot;Hello World&quot; &gt; hello.adoc</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.705')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.2166">~@dollar@ git status</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.2166')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.4185">~@dollar@ git add .
~@dollar@ git commit -m &quot;Second commit&quot;

[main 7b7d8e6] Second commit
 3 files changed, 2 insertions(+), 2 deletions(-)
 create mode 100644 hello.adoc
 delete mode 100644 hello.txt</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.4185')">Copy</button></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.6384">~@dollar@ git status

On branch main
nothing to commit, working tree clean</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.6384')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738127.464">~@dollar@ git log
...
Date:   Wed Sep 26 23:08:00 2018 +0200
    ...
    First commit</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738127.464')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.1558">~@dollar@ echo &quot;Fichier Asciidoc&quot; @GT hello.adoc
~@dollar@ git diff</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.1558')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.9485">~@dollar@ echo &quot;Hello World&quot; @GT hello.adoc
~@dollar@ git status
On branch main
...
~@dollar@ git status
On branch main
nothing to commit, working tree clean</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.9485')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.2334">~@dollar@ git branch
feat/hairs
* main</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.2334')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.2476">~@dollar@ git branch test
~@dollar@ git branch
* main
test</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.2476')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.213">~@dollar@ git checkout test
~@dollar@ git branch
main
main
* test</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.213')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.303">~@dollar@ echo &quot;Fichier Asciidoc updated&quot; @GT hello.adoc
~@dollar@ git add .
~@dollar@ git commit -m &quot;Third commit&quot;</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.303')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.131">~@dollar@ git log
~@dollar@ git checkout main
~@dollar@ git log</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.131')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.0964">~@dollar@ git diff test...main</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.0964')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.171">~@dollar@ git diff main...test</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.171')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.0261">~@dollar@ git log
...
Date:   Wed Sep 26 23:51:10 2018 +0200
    ...
    Second  commit
...</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.0261')">Copy</button></pre>
</div>
</div>
<div class="olist arabic">
<ol class="arabic">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.288">~@dollar@ git checkout main
~@dollar@ git branch test2
~@dollar@ git checkout test2
~@dollar@ echo &quot;Fichier toto&quot; &gt; toto.adoc
~@dollar@ git add .
~@dollar@ git commit -m &quot;Fourth commit&quot;</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.288')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738128.103">~@dollar@ git checkout main
~@dollar@ git merge test</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738128.103')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738129.4226">~@dollar@ git checkout test
~@dollar@ git branch -d test
error: Cannot delete branch &#x27;test&#x27; checked out at &#x27;/home/devmind/Workspace/java/git-demo&#x27;

~@dollar@ git checkout main
~@dollar@ git branch -d test
Deleted branch test (was 9fd87d1).</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738129.4226')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738129.4705">~@dollar@ git checkout main
~@dollar@ git remote add origin https://github.com/Dev-Mind/git-demo.git  (1)
~@dollar@ git push -u origin main                                       (2)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738129.4705')">Copy</button></pre>
</div>
</div>
<div class="olist arabic">
<ol class="arabic">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738129.1377">~@dollar@ git checkout feat/new_hair
~@dollar@ git push -u origin feat/new_hair</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738129.1377')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>These commands</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722865738129.1177">~@dollar@ git pull</code><button class="btn-copy-code" onclick="copyToClipboard('1722865738129.1177')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
