...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737667.3896"><span class="hljs-keyword">interface</span> <span class="hljs-title class_">RoomsApiService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737667.3896')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737668.2346"><span class="hljs-meta">@GET(<span class="hljs-string">&quot;rooms/{id}&quot;</span>)</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findById</span><span class="hljs-params">(<span class="hljs-meta">@Path(<span class="hljs-string">&quot;id&quot;</span>)</span> id: <span class="hljs-type">Long</span>)</span></span>: <span class="hljs-symbol">Call@</span><span class="hljs-symbol">LTRoomDto@</span>GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737668.2346')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737670.7092"><span class="hljs-meta">@PUT(<span class="hljs-string">&quot;rooms/{id}&quot;</span>)</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">updateRoom</span><span class="hljs-params">(<span class="hljs-meta">@Path(<span class="hljs-string">&quot;id&quot;</span>)</span> id: <span class="hljs-type">Long</span>, <span class="hljs-meta">@Body</span> room: <span class="hljs-type">RoomCommandDto</span>)</span></span>: <span class="hljs-symbol">Call@</span><span class="hljs-symbol">LTRoomDto@</span>GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737670.7092')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737672.4639"><span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomDto</span>(
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737672.4639')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1722865737676.167">implementation <span class="hljs-string">&quot;com.squareup.retrofit2:retrofit:2.9.0&quot;</span>
implementation <span class="hljs-string">&quot;com.squareup.retrofit2:converter-moshi:2.9.0&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722865737676.167')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737677.5454"><span class="hljs-keyword">object</span> ApiServices {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737677.5454')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737677.1787"><span class="hljs-keyword">const</span> <span class="hljs-keyword">val</span> API_USERNAME = <span class="hljs-string">&quot;user&quot;</span>
<span class="hljs-keyword">const</span> <span class="hljs-keyword">val</span> API_PASSWORD = <span class="hljs-string">&quot;password&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722865737677.1787')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737678.4392"><span class="hljs-keyword">class</span> <span class="hljs-title class_">BasicAuthInterceptor</span>(<span class="hljs-keyword">val</span> username: String, <span class="hljs-keyword">val</span> password: String): Interceptor {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737678.4392')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737679.053"><span class="hljs-keyword">val</span> roomsApiService : RoomsApiService <span class="hljs-keyword">by</span> lazy {
    ...
    Retrofit.Builder()
        ...
        .build()
        .create(RoomsApiService::<span class="hljs-keyword">class</span>.java)
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737679.053')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737681.3708"><span class="hljs-keyword">val</span> roomsApiService : RoomsApiService <span class="hljs-keyword">by</span> lazy {
...
<span class="hljs-keyword">private</span> <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">getUnsafeOkHttpClient</span><span class="hljs-params">()</span></span>: OkHttpClient.Builder =
  OkHttpClient.Builder().apply {
      ...
      addInterceptor(BasicAuthInterceptor(API_USERNAME, API_PASSWORD))
  }</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737681.3708')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737682.381"> runCatching { <span class="hljs-comment">// (1)</span>
    ...
    }</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737682.381')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737682.5757">implementation(<span class="hljs-string">&quot;androidx.lifecycle:lifecycle-runtime-ktx:2.6.2&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737682.5757')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737682.315">lifecycleScope.launch(context = Dispatchers.IO) { <span class="hljs-comment">// (1)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737682.315')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722865737683.1208">@LTmanifest xmlns:android=&quot;http://schemas.android.com/apk/res/android&quot;
package=&quot;com.example.snazzyapp&quot;@GT
    ...
    @LTapplication ...
        ...
        ...
    @LT/application@GT
@LT/manifest@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737683.1208')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737683.3484"><span class="hljs-keyword">val</span> roomName = <span class="hljs-symbol">findViewById@</span><span class="hljs-symbol">LTEditText@</span>GT(R.id.txt_room_name)
...
roomTargetTemperature.setText(room?.targetTemperature?.toString() ?: <span class="hljs-string">&quot;&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737683.3484')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865737685.6616"><span class="hljs-keyword">private</span> <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">populateScreen</span><span class="hljs-params">(room: <span class="hljs-type">RoomDto</span>?)</span></span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865737685.6616')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
