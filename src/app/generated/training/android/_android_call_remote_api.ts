...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924909.0466"><span class="hljs-keyword">interface</span> <span class="hljs-title class_">RoomsApiService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924909.0466')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924910.624"><span class="hljs-meta">@GET(<span class="hljs-string">&quot;rooms/{id}&quot;</span>)</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findById</span><span class="hljs-params">(<span class="hljs-meta">@Path(<span class="hljs-string">&quot;id&quot;</span>)</span> id: <span class="hljs-type">Long</span>)</span></span>: <span class="hljs-symbol">Call@</span><span class="hljs-symbol">LTRoomDto@</span>GT</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924910.624')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924911.6067"><span class="hljs-meta">@PUT(<span class="hljs-string">&quot;rooms/{id}&quot;</span>)</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">updateRoom</span><span class="hljs-params">(<span class="hljs-meta">@Path(<span class="hljs-string">&quot;id&quot;</span>)</span> id: <span class="hljs-type">Long</span>, <span class="hljs-meta">@Body</span> room: <span class="hljs-type">RoomCommandDto</span>)</span></span>: <span class="hljs-symbol">Call@</span><span class="hljs-symbol">LTRoomDto@</span>GT</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924911.6067')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924912.6033"><span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomDto</span>(
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924912.6033')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-toml" id="1731527924915.3018"><span class="hljs-attr">retrofit</span> = <span class="hljs-string">&quot;2.9.0&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924915.3018')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-toml" id="1731527924916.0159"><span class="hljs-attr">retrofit</span> = { module = <span class="hljs-string">&quot;com.squareup.retrofit2:retrofit&quot;</span>, version.ref = <span class="hljs-string">&quot;retrofit&quot;</span> }
<span class="hljs-attr">retrofit-moshi</span> = { module = <span class="hljs-string">&quot;com.squareup.retrofit2:converter-moshi&quot;</span>, version.ref = <span class="hljs-string">&quot;retrofit&quot;</span> }</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924916.0159')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731527924916.4585">implementation (libs.retrofit)
implementation (libs.converter.moshi)</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924916.4585')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924916.134"><span class="hljs-keyword">object</span> ApiServices {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924916.134')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924917.002"><span class="hljs-keyword">const</span> <span class="hljs-keyword">val</span> API_USERNAME = <span class="hljs-string">&quot;user&quot;</span>
<span class="hljs-keyword">const</span> <span class="hljs-keyword">val</span> API_PASSWORD = <span class="hljs-string">&quot;password&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924917.002')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924917.8247"><span class="hljs-keyword">class</span> <span class="hljs-title class_">BasicAuthInterceptor</span>(<span class="hljs-keyword">val</span> username: String, <span class="hljs-keyword">val</span> password: String): Interceptor {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924917.8247')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924917.4248"><span class="hljs-keyword">val</span> roomsApiService : RoomsApiService <span class="hljs-keyword">by</span> lazy {
    ...
    Retrofit.Builder()
        ...
        .build()
        .create(RoomsApiService::<span class="hljs-keyword">class</span>.java)
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924917.4248')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924919.0378"><span class="hljs-keyword">val</span> roomsApiService : RoomsApiService <span class="hljs-keyword">by</span> lazy {
...
<span class="hljs-keyword">private</span> <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">getUnsafeOkHttpClient</span><span class="hljs-params">()</span></span>: OkHttpClient.Builder =
  OkHttpClient.Builder().apply {
      ...
      addInterceptor(BasicAuthInterceptor(API_USERNAME, API_PASSWORD))
  }</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924919.0378')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924919.736"> runCatching {  <span class="hljs-comment">// (1)</span>
   ApiServices.roomsApiService.findAll().execute()  <span class="hljs-comment">// (2)</span>
      ...
      }</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924919.736')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924920.4165">implementation(libs.androidx.lifecycle.runtime.ktx)</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924920.4165')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924920.9138">lifecycleScope.launch(context = Dispatchers.IO) { <span class="hljs-comment">// (1)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924920.9138')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1731527924920.5903">@LTmanifest xmlns:android=&quot;http://schemas.android.com/apk/res/android&quot;
package=&quot;com.example.snazzyapp&quot;@GT
    ...
    @LTapplication ...
        ...
        ...
    @LT/application@GT
@LT/manifest@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924920.5903')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924920.0552"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomList</span>(
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924920.0552')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924921.5986"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomViewModel</span> : <span class="hljs-type">ViewModel</span>() {
    <span class="hljs-comment">// existing code</span>

    <span class="hljs-keyword">val</span> roomsState = MutableStateFlow(RoomList())
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924921.5986')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924921.8413"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomViewModel</span> : <span class="hljs-type">ViewModel</span>() {
    <span class="hljs-comment">// existing code</span>
    <span class="hljs-comment">//...</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924921.8413')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924922.7173"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomListActivity</span> : <span class="hljs-type">ComponentActivity</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924922.7173')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924923.489"><span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findRoom</span><span class="hljs-params">(id: <span class="hljs-type">Long</span>)</span></span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924923.489')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731527924923.6292"><span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">updateRoom</span><span class="hljs-params">(id: <span class="hljs-type">Long</span>, roomDto: <span class="hljs-type">RoomDto</span>)</span></span> {
  ...
  }</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924923.6292')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
