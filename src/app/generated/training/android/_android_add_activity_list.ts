...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055768648.5977"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomsAdapter</span> : <span class="hljs-type">RecyclerView.Adapter@LTRoomsAdapter.RoomsViewHolder@GT</span>() { <span class="hljs-comment">// (1)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055768648.5977')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055768650.799"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomsActivity</span> : <span class="hljs-type">BasicActivity</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055768650.799')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055768651.2976"><span class="hljs-keyword">interface</span> <span class="hljs-title class_">OnRoomClickListener</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055768651.2976')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055768652.7659">We will implement the contract and create an Intent to <span class="hljs-keyword">open</span> a <span class="hljs-meta">@backtick</span><span class="hljs-meta">@RoomActivity</span><span class="hljs-meta">@backtick</span>@</code><button class="btn-copy-code" onclick="copyToClipboard('1724055768652.7659')">Copy</button></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055768653.5146"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomsAdapter</span>(<span class="hljs-keyword">val</span> listener: OnRoomClickListener): RecyclerView.<span class="hljs-symbol">Adapter@</span>LTRoomsAdapter.<span class="hljs-symbol">RoomsViewHolder@</span>GT() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055768653.5146')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
