...
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004614.0388"><span class="hljs-tag">&lt;<span class="hljs-name">resources</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">resources</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722609004614.0388')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004615.3489"><span class="hljs-tag">&lt;<span class="hljs-name">resources</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">string</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;app_name&quot;</span>&gt;</span>automacorp<span class="hljs-tag">&lt;/<span class="hljs-name">string</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">resources</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722609004615.3489')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722609004617.1494"><span class="hljs-keyword">class</span> <span class="hljs-title class_">MainActivity</span> : <span class="hljs-type">AppCompatActivity</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722609004617.1494')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004618.65">@LTresources xmlns:tools=&quot;http://schemas.android.com/tools&quot;@GT
...
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722609004618.65')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004619.3767">@LT?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?@GT
@LTresources@GT
  @LTcolor name=&quot;black&quot;@GT#FF000000@LT/color@GT
  @LTcolor name=&quot;white&quot;@GT#FFFFFFFF@LT/color@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722609004619.3767')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004619.4216">@LT?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?@GT
@LTresources@GT
  @LTcolor name=&quot;black&quot;@GT#FF000000@LT/color@GT
  @LTcolor name=&quot;white&quot;@GT#FFFFFFFF@LT/color@GT
  @LTcolor name=&quot;primary&quot;@GT#2979ff@LT/color@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722609004619.4216')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1722609004619.0295">@LTresources xmlns:tools=&quot;http://schemas.android.com/tools&quot;@GT
    @LT!-- Base application theme. -@LAMBDA
    @LTstyle name=&quot;Base.Theme.Automacorp&quot; parent=&quot;Theme.Material3.DayNight.NoActionBar&quot;@GT
    ...
    @LTstyle name=&quot;Theme.Automacorp&quot; parent=&quot;Base.Theme.Automacorp&quot; /@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1722609004619.0295')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
