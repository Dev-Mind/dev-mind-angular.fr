...
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769105.9543"><span class="hljs-tag">&lt;<span class="hljs-name">resources</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">resources</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1724055769105.9543')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769106.3853"><span class="hljs-tag">&lt;<span class="hljs-name">resources</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">string</span> <span class="hljs-attr">name</span>=<span class="hljs-string">&quot;app_name&quot;</span>&gt;</span>automacorp<span class="hljs-tag">&lt;/<span class="hljs-name">string</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">resources</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1724055769106.3853')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1724055769108.4495"><span class="hljs-keyword">class</span> <span class="hljs-title class_">MainActivity</span> : <span class="hljs-type">AppCompatActivity</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769108.4495')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769109.3806">@LTresources xmlns:tools=&quot;http://schemas.android.com/tools&quot;@GT
...
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769109.3806')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769110.4485">@LT?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?@GT
@LTresources@GT
  @LTcolor name=&quot;black&quot;@GT#FF000000@LT/color@GT
  @LTcolor name=&quot;white&quot;@GT#FFFFFFFF@LT/color@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769110.4485')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769110.111">@LT?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?@GT
@LTresources@GT
  @LTcolor name=&quot;black&quot;@GT#FF000000@LT/color@GT
  @LTcolor name=&quot;white&quot;@GT#FFFFFFFF@LT/color@GT
  @LTcolor name=&quot;primary&quot;@GT#2979ff@LT/color@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769110.111')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1724055769110.6414">@LTresources xmlns:tools=&quot;http://schemas.android.com/tools&quot;@GT
    @LT!-- Base application theme. -@LAMBDA
    @LTstyle name=&quot;Base.Theme.Automacorp&quot; parent=&quot;Theme.Material3.DayNight.NoActionBar&quot;@GT
    ...
    @LTstyle name=&quot;Theme.Automacorp&quot; parent=&quot;Base.Theme.Automacorp&quot; /@GT
@LT/resources@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1724055769110.6414')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
