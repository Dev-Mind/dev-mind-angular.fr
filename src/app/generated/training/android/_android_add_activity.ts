...
<div class="content">
<pre class="highlight"><code class="language-xml" id="1755673435780.2358">@LTstring name=&quot;act_room_name&quot;@GTRoom name@LT/string@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435780.2358')">Copy</button></pre>
</div>
</div>
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435780.9634"><span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomActivity</span> : <span class="hljs-type">ComponentActivity</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435780.9634')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435780.0488"><span class="hljs-keyword">class</span> <span class="hljs-title class_">MainActivity</span> : <span class="hljs-type">ComponentActivity</span>() {
    ...
    <span class="hljs-comment">// ...</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435780.0488')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435780.3015"><span class="hljs-keyword">val</span> onSayHelloButtonClick: (name: String) <span class="hljs-meta">@LAMBDA</span> <span class="hljs-built_in">Unit</span> = { name <span class="hljs-meta">@LAMBDA</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435780.3015')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435780.9473"><span class="hljs-keyword">override</span> <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">onCreate</span><span class="hljs-params">(savedInstanceState: <span class="hljs-type">Bundle</span>?)</span></span> {
        <span class="hljs-keyword">super</span>.onCreate(savedInstanceState)
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435780.9473')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435781.2156"><span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">RoomDto</span>(
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435781.2156')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435781.4316"><span class="hljs-keyword">enum</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">WindowStatus</span> { OPENED, CLOSED}
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435781.4316')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435781.4478"><span class="hljs-keyword">object</span> RoomService {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435781.4478')">Copy</button></pre>
</div>
</div>
</li>
</ol>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435781.4553"><span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">updateRoom</span><span class="hljs-params">(id: <span class="hljs-type">Long</span>, room: <span class="hljs-type">RoomDto</span>)</span></span>: RoomDto? {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435781.4553')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1755673435782.6985">    @LTstring name=&quot;act_room_name&quot;@GTRoom name@LT/string@GT
    ...
    @LTstring name=&quot;act_room_target_temperature&quot;@GTTarget temperature@LT/string@GT</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435782.6985')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435782.62"><span class="hljs-keyword">override</span> <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">onCreate</span><span class="hljs-params">(savedInstanceState: <span class="hljs-type">Bundle</span>?)</span></span> {
    <span class="hljs-keyword">super</span>.onCreate(savedInstanceState)
    enableEdgeToEdge()
    <span class="hljs-keyword">val</span> param = intent.getStringExtra(MainActivity.ROOM_PARAM)
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435782.62')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435782.4514">    <span class="hljs-keyword">var</span> room <span class="hljs-keyword">by</span> remember { mutableStateOf(roomDto) }
    Column(modifier = modifier.padding(<span class="hljs-number">16.</span>dp)) {
        ...
        <span class="hljs-comment">// ...</span>
    }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435782.4514')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1755673435782.5618">    Slider(
    ...
    Text(text = (round((room.targetTemperature ?: <span class="hljs-number">18.0</span>) * <span class="hljs-number">10</span>) / <span class="hljs-number">10</span>).toString())</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435782.5618')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
