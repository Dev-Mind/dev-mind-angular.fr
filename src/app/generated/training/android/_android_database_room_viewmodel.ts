...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686897.9944"><span class="hljs-meta">@Entity(tableName = <span class="hljs-string">&quot;rwindow&quot;</span>)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686897.9944')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686898.3025"><span class="hljs-keyword">class</span> <span class="hljs-title class_">EnumConverters</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686898.3025')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686898.2654"><span class="hljs-meta">@Dao</span>
<span class="hljs-keyword">interface</span> <span class="hljs-title class_">WindowDao</span> {
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686898.2654')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686899.5674"><span class="hljs-meta">@Dao</span>
<span class="hljs-keyword">interface</span> <span class="hljs-title class_">WindowDao</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.5674')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686899.8057"><span class="hljs-meta">@Database(entities = [Window::class], version = 1)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.8057')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686899.353"><span class="hljs-keyword">class</span> <span class="hljs-title class_">AutomacorpApplication</span> : <span class="hljs-type">Application</span>() {}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.353')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-xml" id="1723541686899.5046">@LTmanifest xmlns:android=&quot;http://schemas.android.com/apk/res/android&quot;
xmlns:tools=&quot;http://schemas.android.com/tools&quot;@GT
    @LTapplication
        android:name=&quot;.AutomacorpApplication&quot;
     ...</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.5046')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686899.8123"><span class="hljs-keyword">class</span> <span class="hljs-title class_">AutomacorpApplication</span> : <span class="hljs-type">Application</span>() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.8123')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686899.2239"><span class="hljs-keyword">val</span> windowDao = AutomacorpApplication.database.windowDao()</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686899.2239')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686900.6343"><span class="hljs-keyword">class</span> <span class="hljs-title class_">WindowViewModel</span>(<span class="hljs-keyword">private</span> <span class="hljs-keyword">val</span> windowDao: WindowDao) : ViewModel() { <span class="hljs-comment">// (1)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686900.6343')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686900.633"><span class="hljs-keyword">class</span> <span class="hljs-title class_">WindowViewModel</span>(<span class="hljs-keyword">private</span> <span class="hljs-keyword">val</span> windowDao: WindowDao) : ViewModel() {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686900.633')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686900.6555"><span class="hljs-keyword">private</span> <span class="hljs-keyword">val</span> viewModel: WindowViewModel <span class="hljs-keyword">by</span> viewModels {
    WindowViewModel.factory
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686900.6555')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686900.2273">viewModel.findAll().observe(<span class="hljs-keyword">this</span>) { windows <span class="hljs-meta">@LAMBDA</span>
    adapter.update(windows)
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686900.2273')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1723541686900.7446">plugins {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686900.7446')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1723541686901.4292">implementation <span class="hljs-string">&quot;androidx.room:room-runtime:2.4.3&quot;</span>
...
implementation <span class="hljs-string">&quot;androidx.activity:activity-ktx:1.6.0&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1723541686901.4292')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686901.6323"><span class="hljs-keyword">private</span> <span class="hljs-keyword">val</span> viewModel: RoomViewModel <span class="hljs-keyword">by</span> viewModels {
    RoomViewModel.factory
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686901.6323')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686901.449">viewModel.findAll().observe(<span class="hljs-keyword">this</span>) { rooms <span class="hljs-meta">@LAMBDA</span>
    roomsAdapter.setItems(rooms) }
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686901.449')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">save</span><span class="hljs-params">(roomId: <span class="hljs-type">Long</span>, room: <span class="hljs-type">RoomCommandDto</span>)</span></span>: <span class="hljs-symbol">LiveData@</span>LTRoomDto?<span class="hljs-meta">@GT</span> =
    ...
    }</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686901.746')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686901.5662"><span class="hljs-keyword">enum</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">State</span> { ONLINE, OFFLINE }</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686901.5662')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686902.7627"><span class="hljs-keyword">val</span> networkState: <span class="hljs-symbol">MutableLiveData@</span><span class="hljs-symbol">LTState@</span>GT <span class="hljs-keyword">by</span> lazy {
    <span class="hljs-symbol">MutableLiveData@</span><span class="hljs-symbol">LTState@</span>GT().also { it.postValue(State.ONLINE) }
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686902.7627')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541686902.845">viewModel.networkState.observe(<span class="hljs-keyword">this</span>) { state <span class="hljs-meta">@LAMBDA</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686902.845')">Copy</button></pre>
</div>
</div>
</li>
<li>
...
<pre class="highlight"><code class="language-kotlin" id="1723541686902.642"><span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findById</span><span class="hljs-params">(roomId: <span class="hljs-type">Long</span>)</span></span>: <span class="hljs-symbol">LiveData@</span><span class="hljs-symbol">LTRoomDto@</span>GT =
    ...
    }</code><button class="btn-copy-code" onclick="copyToClipboard('1723541686902.642')">Copy</button></pre>
</div>
</div>
</li>
</ol>
