...
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436114.0466"><span class="hljs-meta">@Component</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436114.0466')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436115.747">testCompile(<span class="hljs-string">&quot;com.squareup.okhttp3:mockwebserver:3.9.1&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436115.747')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436115.7307"><span class="hljs-keyword">public</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">ElasticMailSenderTest</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436115.7307')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436115.7961">WebClient.create(<span class="hljs-built_in">this</span>.server.url(<span class="hljs-string">&quot;/&quot;</span>).toString())</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436115.7961')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436115.623">configurations {
	all {
...
testRuntime(<span class="hljs-string">&quot;org.junit.jupiter:junit-jupiter-engine&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436115.623')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436115.8547">testCompile(<span class="hljs-string">&quot;com.devmind:mockwebserver:0.1.0&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436115.8547')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436116.2156"><span class="hljs-meta">@ExtendWith(MockWebServerExtension.class)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436116.2156')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436116.1738"><span class="hljs-meta">@ExtendWith(MockSimpleWebServerExtension.class)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436116.1738')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
