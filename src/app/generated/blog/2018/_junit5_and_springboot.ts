...
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436107.7366"><span class="hljs-meta">@ConfigurationProperties(&quot;devmind&quot;)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436107.7366')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436107.096"><span class="hljs-meta">@SpringBootApplication</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436107.096')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436108.1887"><span class="hljs-keyword">import</span> org.assertj.core.api.Assertions;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.1887')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.4495">buildscript {
	ext {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.4495')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.5667">classpath(<span class="hljs-string">&quot;org.junit.platform:junit-platform-gradle-plugin:@dollar@{junitPlatformVersion}&quot;</span>)
apply <span class="hljs-attr">plugin:</span> <span class="hljs-string">&quot;org.junit.platform.gradle.plugin&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.5667')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.7773">testCompile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-test&quot;</span>) {
	exclude <span class="hljs-attr">module:</span> <span class="hljs-string">&quot;junit&quot;</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.7773')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.6765">configurations {
	all {
		exclude <span class="hljs-attr">module:</span> <span class="hljs-string">&quot;junit&quot;</span>
	}
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.6765')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.7935">testCompile(<span class="hljs-string">&quot;org.junit.jupiter:junit-jupiter-api&quot;</span>)
testRuntime(<span class="hljs-string">&quot;org.junit.jupiter:junit-jupiter-engine&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.7935')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1755673436108.7583">testRuntime(<span class="hljs-string">&quot;org.junit.vintage:junit-vintage-engine:4.12.2&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.7583')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436108.589"><span class="hljs-meta">@ExtendWith(MockitoExtension.class)</span>
<span class="hljs-meta">@ExtendWith(SpringExtension.class)</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.589')">Copy</button></pre>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436108.6965"><span class="hljs-keyword">import</span> org.assertj.core.api.Assertions;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.6965')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436108.1316"><span class="hljs-meta">@ExtendWith(SpringExtension.class)</span>
...
<span class="hljs-meta">@ActiveProfiles(&quot;dev&quot;)</span>
<span class="hljs-meta">@Transactional</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">UserRepositoryTests</span> { }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436108.1316')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.4973"><span class="hljs-meta">@Target(ElementType.TYPE)</span>
<span class="hljs-meta">@Retention(RetentionPolicy.RUNTIME)</span>
<span class="hljs-meta">@ExtendWith(SpringExtension.class)</span>
<span class="hljs-meta">@ContextConfiguration({&quot;/app-config.xml&quot;, &quot;/test-data-access-config.xml&quot;})</span>
<span class="hljs-meta">@ActiveProfiles(&quot;dev&quot;)</span>
<span class="hljs-meta">@Transactional</span>
<span class="hljs-keyword">public</span> <span class="hljs-meta">@interface</span> TransactionalDevTestConfig { }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.4973')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.2732"><span class="hljs-meta">@TransactionalDevTestConfig</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">OrderRepositoryTests</span> { }

<span class="hljs-meta">@TransactionalDevTestConfig</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">UserRepositoryTests</span> { }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.2732')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.6255"><span class="hljs-keyword">public</span> <span class="hljs-keyword">interface</span> <span class="hljs-title class_">CallForPaperService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.6255')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.135"><span class="hljs-keyword">class</span> <span class="hljs-title class_">CallForPaperServiceTests</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.135')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1755673436109.922"><span class="hljs-title function_">it</span>(<span class="hljs-string">&#x27;submit should fail when required data are absent&#x27;</span>, <span class="hljs-function">() =&gt;</span> { });</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.922')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.6626"><span class="hljs-meta">@Test</span>
fun <span class="hljs-meta">@backtick</span><span class="hljs-meta">@submit</span> should fail when required data are absent<span class="hljs-meta">@backtick</span>@() {  }</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.6626')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436109.9639"><span class="hljs-meta">@DisplayName(&quot;Test service CallForPaperService&quot;)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436109.9639')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>Ce qui donnerait le rapport suivant</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436110.4138"><span class="hljs-meta">@DisplayName(&quot;Test service CallForPaperService&quot;)</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">CallForPaperServiceTests</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436110.4138')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436110.318"><span class="hljs-meta">@Test</span>
<span class="hljs-meta">@DisplayName(&quot;should send email to session speakers&quot;)</span>
<span class="hljs-meta">@RepeatedTest(10)</span>
<span class="hljs-keyword">public</span> <span class="hljs-keyword">void</span> <span class="hljs-title function_">acceptSendEmailToSessionSpeakers</span><span class="hljs-params">()</span>{
    assertThat(<span class="hljs-literal">true</span>).isTrue();
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436110.318')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436110.5964"><span class="hljs-meta">@Category({IntegrationTest.class, Exernal.class})</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673436110.5964')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436110.8364"><span class="hljs-meta">@Tag(&quot;integration&quot;)</span>
<span class="hljs-meta">@Tag(&quot;exernal&quot;)</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673436110.8364')">Copy</button></pre>
</div>
</div>
<div class="sidebarblock">
<div class="content">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673436110.4778">junitPlatform {
    filters {
        tags {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673436110.4778')">Copy</button></pre>
</div>
</div>
</div>
</div>
