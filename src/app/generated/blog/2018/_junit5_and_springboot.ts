...
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745092.732"><span class="hljs-meta">@ConfigurationProperties(&quot;devmind&quot;)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745092.732')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745093.9944"><span class="hljs-meta">@SpringBootApplication</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745093.9944')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745094.0176"><span class="hljs-keyword">import</span> org.assertj.core.api.Assertions;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745094.0176')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745098.0916">buildscript {
	ext {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745098.0916')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745098.1775">classpath(<span class="hljs-string">&quot;org.junit.platform:junit-platform-gradle-plugin:@dollar@{junitPlatformVersion}&quot;</span>)
apply <span class="hljs-attr">plugin:</span> <span class="hljs-string">&quot;org.junit.platform.gradle.plugin&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731601745098.1775')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745099.0708">testCompile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-test&quot;</span>) {
	exclude <span class="hljs-attr">module:</span> <span class="hljs-string">&quot;junit&quot;</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745099.0708')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745099.9026">configurations {
	all {
		exclude <span class="hljs-attr">module:</span> <span class="hljs-string">&quot;junit&quot;</span>
	}
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745099.9026')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745099.736">testCompile(<span class="hljs-string">&quot;org.junit.jupiter:junit-jupiter-api&quot;</span>)
testRuntime(<span class="hljs-string">&quot;org.junit.jupiter:junit-jupiter-engine&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745099.736')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1731601745099.3748">testRuntime(<span class="hljs-string">&quot;org.junit.vintage:junit-vintage-engine:4.12.2&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745099.3748')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745100.1392"><span class="hljs-meta">@ExtendWith(MockitoExtension.class)</span>
<span class="hljs-meta">@ExtendWith(SpringExtension.class)</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731601745100.1392')">Copy</button></pre>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745101.5232"><span class="hljs-keyword">import</span> org.assertj.core.api.Assertions;
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745101.5232')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745101.7021"><span class="hljs-meta">@ExtendWith(SpringExtension.class)</span>
...
<span class="hljs-meta">@ActiveProfiles(&quot;dev&quot;)</span>
<span class="hljs-meta">@Transactional</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">UserRepositoryTests</span> { }</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745101.7021')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745102.782"><span class="hljs-meta">@Target(ElementType.TYPE)</span>
<span class="hljs-meta">@Retention(RetentionPolicy.RUNTIME)</span>
<span class="hljs-meta">@ExtendWith(SpringExtension.class)</span>
<span class="hljs-meta">@ContextConfiguration({&quot;/app-config.xml&quot;, &quot;/test-data-access-config.xml&quot;})</span>
<span class="hljs-meta">@ActiveProfiles(&quot;dev&quot;)</span>
<span class="hljs-meta">@Transactional</span>
<span class="hljs-keyword">public</span> <span class="hljs-meta">@interface</span> TransactionalDevTestConfig { }</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745102.782')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745102.5635"><span class="hljs-meta">@TransactionalDevTestConfig</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">OrderRepositoryTests</span> { }

<span class="hljs-meta">@TransactionalDevTestConfig</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">UserRepositoryTests</span> { }</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745102.5635')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745103.4158"><span class="hljs-keyword">public</span> <span class="hljs-keyword">interface</span> <span class="hljs-title class_">CallForPaperService</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745103.4158')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745104.512"><span class="hljs-keyword">class</span> <span class="hljs-title class_">CallForPaperServiceTests</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745104.512')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731601745105.2898"><span class="hljs-title function_">it</span>(<span class="hljs-string">&#x27;submit should fail when required data are absent&#x27;</span>, <span class="hljs-function">() =&gt;</span> { });</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745105.2898')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745105.7314"><span class="hljs-meta">@Test</span>
fun <span class="hljs-meta">@backtick</span><span class="hljs-meta">@submit</span> should fail when required data are absent<span class="hljs-meta">@backtick</span>@() {  }</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745105.7314')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745107.3208"><span class="hljs-meta">@DisplayName(&quot;Test service CallForPaperService&quot;)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745107.3208')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>Ce qui donnerait le rapport suivant</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745109.7573"><span class="hljs-meta">@DisplayName(&quot;Test service CallForPaperService&quot;)</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">CallForPaperServiceTests</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745109.7573')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745109.8503"><span class="hljs-meta">@Test</span>
<span class="hljs-meta">@DisplayName(&quot;should send email to session speakers&quot;)</span>
<span class="hljs-meta">@RepeatedTest(10)</span>
<span class="hljs-keyword">public</span> <span class="hljs-keyword">void</span> <span class="hljs-title function_">acceptSendEmailToSessionSpeakers</span><span class="hljs-params">()</span>{
    assertThat(<span class="hljs-literal">true</span>).isTrue();
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745109.8503')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745109.0947"><span class="hljs-meta">@Category({IntegrationTest.class, Exernal.class})</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731601745109.0947')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745110.4724"><span class="hljs-meta">@Tag(&quot;integration&quot;)</span>
<span class="hljs-meta">@Tag(&quot;exernal&quot;)</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731601745110.4724')">Copy</button></pre>
</div>
</div>
<div class="sidebarblock">
<div class="content">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1731601745110.9038">junitPlatform {
    filters {
        tags {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731601745110.9038')">Copy</button></pre>
</div>
</div>
</div>
</div>
