...
<div class="content">
<pre class="highlight"><code class="language-adoc" id="1731527924294.803"><span class="hljs-section">= Title Slide</span>
...
<span class="hljs-section">== Slide Ten js...</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924294.803')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-adoc" id="1731527924297.3125"><span class="hljs-meta">:revealjs_theme:</span> league
<span class="hljs-meta">:revealjs_customtheme:</span> css/custom.css</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924297.3125')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<span class="hljs-selector-class">.reveal</span> {
  ...
  <span class="hljs-attribute">color</span>: <span class="hljs-number">#eee</span>; }</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924298.7537')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-css" id="1731527924300.6948"><span class="hljs-selector-tag">body</span><span class="hljs-selector-pseudo">:after</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924300.6948')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-css" id="1731527924302.4875"><span class="hljs-selector-class">.reveal</span><span class="hljs-selector-pseudo">:before</span> {
  ...
  <span class="hljs-attribute">text-align</span>: center;
  <span class="hljs-attribute">font-size</span>: <span class="hljs-number">0.9rem</span>;
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924302.4875')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-adoc" id="1731527924302.6086"><span class="hljs-meta">[state=dynamic-example]</span>
<span class="hljs-section">== Slide Ten js...</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924302.6086')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-adoc" id="1731527924303.6292">Reveal.addEventListener( <span class="hljs-emphasis">&#x27;dynamic-example&#x27;</span>, function() {
<span class="hljs-code">    //</span>
}, false );</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924303.6292')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731527924307.532"><span class="hljs-title class_">Reveal</span>.<span class="hljs-title function_">addEventListener</span>( <span class="hljs-string">&#x27;dynamic&#x27;</span>, <span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) {
...
}, <span class="hljs-literal">false</span> );</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924307.532')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731527924310.0273">gulp.<span class="hljs-title function_">task</span>(<span class="hljs-string">&#x27;copy-html&#x27;</span>, <span class="hljs-function">() =&gt;</span>
...
);</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924310.0273')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
