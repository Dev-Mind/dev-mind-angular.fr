...
<div class="content">
<pre class="highlight"><code class="language-java" id="1722519596958.903">compile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-webflux&quot;</span>)
compile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-data-mongodb-reactive&quot;</span>)
runtime(<span class="hljs-string">&quot;de.flapdoodle.embed:de.flapdoodle.embed.mongo&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1722519596958.903')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519596959.3442"><span class="hljs-meta">@Document</span>
<span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">Talk</span>(
        ...
        <span class="hljs-keyword">val</span> speakerIds: List&amp;lt;String&amp;gt; = emptyList(),
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1722519596959.3442')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519596960.4534"><span class="hljs-meta">@Repository</span>
<span class="hljs-keyword">class</span> <span class="hljs-title class_">TalkRepository</span>(<span class="hljs-keyword">private</span> <span class="hljs-keyword">val</span> template: ReactiveMongoTemplate) {
    ...
    <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findOne</span><span class="hljs-params">(id: <span class="hljs-type">String</span>)</span></span> = template.findById&amp;lt;Talk&amp;gt;(id)

    <span class="hljs-function"><span class="hljs-keyword">fun</span> <span class="hljs-title">findFullText</span><span class="hljs-params">(criteria: <span class="hljs-type">List</span>&amp;<span class="hljs-type">lt</span>;<span class="hljs-type">String</span>&amp;<span class="hljs-type">gt</span>;)</span></span>: Flux&amp;lt;Talk&amp;gt; {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519596960.4534')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
