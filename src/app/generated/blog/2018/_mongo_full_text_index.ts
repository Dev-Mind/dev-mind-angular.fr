...
<div class="content">
<pre class="highlight"><code class="language-java" id="1723541687661.8">compile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-webflux&quot;</span>)
compile(<span class="hljs-string">&quot;org.springframework.boot:spring-boot-starter-data-mongodb-reactive&quot;</span>)
runtime(<span class="hljs-string">&quot;de.flapdoodle.embed:de.flapdoodle.embed.mongo&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687661.8')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541687661.7869"><span class="hljs-meta">@Document</span>
...
)</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687661.7869')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1723541687662.8738"><span class="hljs-meta">@Repository</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1723541687662.8738')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
