...
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770212.4702">gulp.<span class="hljs-title function_">task</span>(<span class="hljs-string">&#x27;images-min&#x27;</span>, <span class="hljs-function">() =&gt;</span>
  gulp.<span class="hljs-title function_">src</span>(<span class="hljs-string">&#x27;src/images/**/*.{svg,png,jpg}&#x27;</span>)
    ...
    .<span class="hljs-title function_">pipe</span>(gulp.<span class="hljs-title function_">dest</span>(<span class="hljs-string">&#x27;build/.tmp/img&#x27;</span>))
);</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770212.4702')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770214.0276"><span class="hljs-keyword">const</span> map = <span class="hljs-built_in">require</span>(<span class="hljs-string">&#x27;map-stream&#x27;</span>);
...
};</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770214.0276')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770216.8962">gulp.<span class="hljs-title function_">task</span>(<span class="hljs-string">&#x27;blog-indexing&#x27;</span>, <span class="hljs-function">(<span class="hljs-params">cb</span>) =&gt;</span> {
...
});</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770216.8962')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770217.0283"><span class="hljs-variable language_">module</span>.<span class="hljs-property">exports</span> = {
...
};</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770217.0283')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770218.5486">{
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770218.5486')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770218.644">{
  <span class="hljs-string">&quot;deploy&quot;</span>: {
    <span class="hljs-string">&quot;webroot&quot;</span>: <span class="hljs-string">&quot;/build/dist&quot;</span>
  }
}</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770218.644')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
