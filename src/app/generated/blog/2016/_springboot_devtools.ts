...
<div class="content">
<pre class="highlight"><code class="language-java" id="1724055770154.2961">compile <span class="hljs-string">&quot;org.springframework.boot:spring-boot-devtools&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1724055770154.2961')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1724055770155.5266">./gradlew bootRun</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770155.5266')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770157.6968"><span class="hljs-attr">spring</span>:
  ...
  <span class="hljs-attr">devtools</span>:
    <span class="hljs-attr">restart</span>:
      ...
      additional-<span class="hljs-attr">exclude</span>: <span class="hljs-string">&quot;**/*.js, **/*.css, **/*.html&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1724055770157.6968')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770157.1353">gulp watch</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770157.1353')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1724055770159.0806">gulp.<span class="hljs-title function_">task</span>(<span class="hljs-string">&#x27;watch&#x27;</span>, [<span class="hljs-string">&#x27;scripts&#x27;</span>, <span class="hljs-string">&#x27;styles&#x27;</span>, <span class="hljs-string">&#x27;html-template&#x27;</span>], <span class="hljs-function">() =&gt;</span> {
...
});</code><button class="btn-copy-code" onclick="copyToClipboard('1724055770159.0806')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
