...
<div class="content">
<pre class="highlight"><code class="language-html" id="1722609005351.1763"><span class="hljs-tag">&lt;<span class="hljs-name">html</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;/<span class="hljs-name">footer</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">body</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722609005351.1763')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-css" id="1722609005369.108"><span class="hljs-selector-tag">html</span>, <span class="hljs-selector-tag">body</span> {
    <span class="hljs-attribute">min-height</span>: <span class="hljs-number">100vh</span>;
    <span class="hljs-attribute">max-height</span>: <span class="hljs-number">100vh</span>;
    <span class="hljs-attribute">margin</span>: <span class="hljs-number">0</span>;
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005369.108')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-css" id="1722609005369.8245"><span class="hljs-attribute">display</span>: flex;
<span class="hljs-attribute">flex-direction</span>: column;</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005369.8245')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1722609005369.1711">header {
    display: flex;
    justify-content: flex-end;
    align-items: center;
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005369.1711')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1722609005369.5715">header {
    flex: 0 0 64px;
}
main {
    flex: 1 1 auto;
...
footer {
    flex: 0 1;
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005369.5715')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1722609005369.5872">grid {
    display: flex;
}
...
grid &gt; div {
    ...
    padding: 1em;
    text-align: center;
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005369.5872')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
