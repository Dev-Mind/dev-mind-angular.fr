...
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1722609005391.3364"><span class="hljs-title function_">it</span>(<span class="hljs-string">&#x27;displays user details on click&#x27;</span>, <span class="hljs-title function_">async</span>(<span class="hljs-function">() =&gt;</span> {
  ...
...
}));</code><button class="btn-copy-code" onclick="copyToClipboard('1722609005391.3364')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
