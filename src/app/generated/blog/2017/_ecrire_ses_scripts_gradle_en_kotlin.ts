...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865739577.2202">buildscript {
    ext {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739577.2202')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>En Kotlin</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1722865739577.6445">buildscript {
    ext {
        nodePluginVersion = <span class="hljs-string">&#x27;1.0.1&#x27;</span>
    }
    repositories {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739577.6445')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1722865739578.9023">apply <span class="hljs-attr">plugin:</span> <span class="hljs-string">&#x27;idea&#x27;</span>
apply <span class="hljs-attr">plugin:</span> <span class="hljs-string">&#x27;com.moowork.node&#x27;</span>
apply <span class="hljs-attr">plugin:</span> <span class="hljs-string">&#x27;com.moowork.gulp&#x27;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722865739578.9023')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>En Kotlin</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865739578.6313">apply {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739578.6313')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1722865739578.7156">node {
    version = <span class="hljs-string">&#x27;6.9.2&#x27;</span>
    download = <span class="hljs-literal">true</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739578.7156')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>En Kotlin</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865739582.9087"><span class="hljs-keyword">import</span> com.moowork.gradle.node.NodeExtension

<span class="hljs-symbol">configure@</span><span class="hljs-symbol">LTNodeExtension@</span>GT {
    version = <span class="hljs-string">&quot;6.9.2&quot;</span>
    download = <span class="hljs-literal">true</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739582.9087')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-groovy" id="1722865739583.8708">task gulpBuild(<span class="hljs-attr">type:</span> GulpTask, <span class="hljs-attr">dependsOn:</span> yarnInstall) {
...
processResources {
  dependsOn gulpBuild
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739583.8708')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>En Kotlin</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722865739584.932"><span class="hljs-keyword">import</span> com.moowork.gradle.gulp.GulpTask
...
tasks.getByName(<span class="hljs-string">&quot;processResources&quot;</span>).dependsOn(<span class="hljs-string">&quot;gulpBuild&quot;</span>)</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739584.932')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
