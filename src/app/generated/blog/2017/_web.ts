...
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435942.9019">protocol::<span class="hljs-comment">//user:password@server:port/path/resource?param1=value1&amp;amp;param2=value2</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435942.9019')">Copy</button></pre>
</div>
</div>
<div class="sect3">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435942.5251">protocol::<span class="hljs-comment">//server/path/resource?param1=value1&amp;amp;param2=value2</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435942.5251')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect3">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435942.8293">https:<span class="hljs-comment">//www.dev-mind.fr/api/conference?name=Mix-IT</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435942.8293')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-html" id="1755673435943.7322"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">id</span>=<span class="hljs-string">&quot;”part1”&quot;</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- code --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- code --&gt;</span>
</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435943.7322')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
