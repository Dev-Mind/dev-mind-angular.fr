...
<div class="content">
<pre class="highlight"><code class="language-java" id="1722519597453.2217">telnet www.google.fr <span class="hljs-number">80</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722519597453.2217')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1722519597453.4856">GET / HTTP/<span class="hljs-number">1.1</span>
Host: www.google.fr
Accept-Language: fr</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597453.4856')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1722519597454.9033">HTTP/<span class="hljs-number">1.1</span> <span class="hljs-number">200</span> OK
...
&amp;lt;/html&amp;gt;</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597454.9033')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>Les codes &gt;= 300 permettent d’indiquer que la requête était valide mais qu’aucune ressource ne sera renvoyé. Un code 301 (Moved Permanently) indique que la ressource a été déplacée. Un code 304 (Not Modified)  est renvoyé quand le client posède déjà la dernière version de la ressource.</p>
</div>
</div>
<div class="sect2">
