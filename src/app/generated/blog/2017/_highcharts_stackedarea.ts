...
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1722865739606.5872">{
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739606.5872')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1722865739614.2495">  <span class="hljs-keyword">function</span> <span class="hljs-title function_">_createSeries</span>(<span class="hljs-params"></span>) {
  ...
  <span class="hljs-keyword">new</span> <span class="hljs-title class_">Highcharts</span>.<span class="hljs-title class_">Chart</span>({<span class="hljs-attr">chart</span>: {<span class="hljs-attr">renderTo</span>: <span class="hljs-string">&#x27;myChart&#x27;</span>}, <span class="hljs-attr">series</span>: <span class="hljs-title function_">_createSeries</span>()})</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739614.2495')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1722865739621.5945">  <span class="hljs-keyword">function</span> <span class="hljs-title function_">evaluator</span>(<span class="hljs-params">measure</span>) {
  ...
  }</code><button class="btn-copy-code" onclick="copyToClipboard('1722865739621.5945')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
