...
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731447061926.5967"><span class="hljs-comment">// Création du worker</span>
...
worker.<span class="hljs-title function_">postMessage</span>(<span class="hljs-string">&#x27;Hello World&#x27;</span>);</code><button class="btn-copy-code" onclick="copyToClipboard('1731447061926.5967')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731447061927.791"><span class="hljs-comment">// On crée un listener pour recevoir les messages du thread principal</span>
...
}, <span class="hljs-literal">false</span>);</code><button class="btn-copy-code" onclick="copyToClipboard('1731447061927.791')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731447061928.2485"><span class="hljs-keyword">if</span> (<span class="hljs-string">&#x27;serviceWorker&#x27;</span> <span class="hljs-keyword">in</span> navigator){
    <span class="hljs-comment">// ..</span>
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731447061928.2485')">Copy</button></pre>
</div>
</div>
<div class="ulist">
<ul>
