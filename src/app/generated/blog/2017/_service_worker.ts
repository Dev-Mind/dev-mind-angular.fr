...
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1734011713878.1194"><span class="hljs-comment">// Création du worker</span>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1734011713879.1597"><span class="hljs-comment">// On crée un listener pour recevoir les messages du thread principal</span>
