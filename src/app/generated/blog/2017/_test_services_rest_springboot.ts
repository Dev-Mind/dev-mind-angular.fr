...
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435936.8606"><span class="hljs-meta">@RestController</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435936.8606')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435936.5085">compile <span class="hljs-string">&quot;javax.validation:validation-api:1.1.0.Final&quot;</span>
compile <span class="hljs-string">&quot;org.hibernate:hibernate-validator:1.1.0.Final&quot;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435936.5085')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435936.6848"><span class="hljs-keyword">public</span> <span class="hljs-keyword">static</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">Session</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435936.6848')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435936.096"><span class="hljs-meta">@RunWith(SpringRunner.class)</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435936.096')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435936.8022"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435936.8022')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435937.9292"><span class="hljs-built_in">this</span>.mvc.perform(get(<span class="hljs-string">&quot;/api/session&quot;</span>).with(httpBasic(<span class="hljs-string">&quot;admin&quot;</span>, <span class="hljs-string">&quot;password&quot;</span>)))
            .andExpect(status().isOk())
            .andExpect(jsonPath(<span class="hljs-string">&quot;@dollar@.length()&quot;</span>, is(<span class="hljs-number">2</span>)))
            .andExpect(jsonPath(<span class="hljs-string">&quot;@dollar@.[0].title&quot;</span>, is(<span class="hljs-string">&quot;title1&quot;</span>)));</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435937.9292')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435937.761"><span class="hljs-meta">@WebMvcTest(value = SessionController.class, secure = false)</span></code><button class="btn-copy-code" onclick="copyToClipboard('1755673435937.761')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435937.7397"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435937.7397')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-java" id="1755673435937.3472"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1755673435937.3472')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
