...
<ul class="sectlevel1">
<a class="link" fragment="#_méthode_extracting_en_java">Méthode <code>extracting</code> en Java</a>
<a class="link" fragment="#_méthode_extracting_en_kotlin">Méthode <code>extracting</code> en Kotlin</a>
<a class="link" fragment="#_le_langage_kotlin_à_la_rescousse">Le langage Kotlin à la rescousse</a>
</ul>
</div>
<div id="preamble">
...
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597605.4563"><span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">Talk</span>(<span class="hljs-keyword">val</span> id: <span class="hljs-built_in">Long</span>, <span class="hljs-keyword">val</span> name: String, <span class="hljs-keyword">val</span> speakerIds: List&amp;lt;<span class="hljs-built_in">Long</span>&amp;gt;)</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597605.4563')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597606.2"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597606.2')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597606.1455"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597606.1455')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597607.6807"><span class="hljs-meta">@Test</span>
    ...
    }</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597607.6807')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>Exemple pour une liste d&#8217;objets</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597608.475"><span class="hljs-meta">@Test</span>
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597608.475')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597608.9385"><span class="hljs-meta">@Test</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> @backtick@should extract property on <span class="hljs-keyword">object</span>@backtick@<span class="hljs-params">()</span></span> {
    <span class="hljs-keyword">val</span> talk = Talk(<span class="hljs-number">1L</span>, <span class="hljs-string">&quot;Fabulous talk&quot;</span>, listOf(<span class="hljs-number">12L</span>, <span class="hljs-number">13L</span>))
    assertThat(talk)
        .extracting(Talk::id, Talk::name, Talk::speakerIds)
        .containsExactly(<span class="hljs-number">1L</span>, <span class="hljs-string">&quot;Fabulous talk&quot;</span>, listOf(<span class="hljs-number">12L</span>, <span class="hljs-number">13L</span>))
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597608.9385')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
<p>Exemple pour une liste d&#8217;objets</p>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597609.9858"><span class="hljs-meta">@Test</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> @backtick@should extract property on list@backtick@<span class="hljs-params">()</span></span> {
    <span class="hljs-keyword">val</span> talks: List&amp;lt;Talk&amp;gt; = listOf(
        Talk(<span class="hljs-number">1L</span>, <span class="hljs-string">&quot;Fabulous talk&quot;</span>, listOf(<span class="hljs-number">12L</span>, <span class="hljs-number">13L</span>)),
        Talk(<span class="hljs-number">2L</span>, <span class="hljs-string">&quot;Other talk&quot;</span>, listOf(<span class="hljs-number">14L</span>))
    )
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597609.9858')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597609.0347"><span class="hljs-meta">@Test</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> @backtick@should extract property on <span class="hljs-keyword">object</span>@backtick@<span class="hljs-params">()</span></span> {
    <span class="hljs-keyword">val</span> talk = Talk(<span class="hljs-number">1L</span>, <span class="hljs-string">&quot;Fabulous talk&quot;</span>, listOf(<span class="hljs-number">12L</span>, <span class="hljs-number">13L</span>))
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597609.0347')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1722519597610.101"><span class="hljs-meta">@Test</span>
<span class="hljs-function"><span class="hljs-keyword">fun</span> @backtick@should extract property on list@backtick@<span class="hljs-params">()</span></span> {
    <span class="hljs-keyword">val</span> talks = listOf(
        Talk(<span class="hljs-number">1L</span>, <span class="hljs-string">&quot;Fabulous talk&quot;</span>, listOf(<span class="hljs-number">12L</span>, <span class="hljs-number">13L</span>)),
        Talk(<span class="hljs-number">2L</span>, <span class="hljs-string">&quot;Other talk&quot;</span>, listOf(<span class="hljs-number">14L</span>))
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1722519597610.101')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
