...
<ul class="sectlevel1">
<li><a href="@link@#_méthode_extracting_en_java">Méthode <code>extracting</code> en Java</a></li>
<li><a href="@link@#_méthode_extracting_en_kotlin">Méthode <code>extracting</code> en Kotlin</a></li>
<li><a href="@link@#_le_langage_kotlin_à_la_rescousse">Le langage Kotlin à la rescousse</a></li>
</ul>
</div>
<div id="preamble">
...
<div class="content">
<pre class="highlight"><code class="language-kotlin"><span class="hljs-keyword">data</span> <span class="hljs-keyword">class</span> <span class="hljs-title class_">Talk</span>(<span class="hljs-keyword">val</span> id: <span class="hljs-built_in">Long</span>, <span class="hljs-keyword">val</span> name: String, <span class="hljs-keyword">val</span> speakerIds: List&amp;lt;<span class="hljs-built_in">Long</span>&amp;gt;)</code></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin"><span class="hljs-meta">@Test</span>
