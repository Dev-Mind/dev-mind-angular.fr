...
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924542.9053">@dollar@ npm
...
npm help npm      involved overview&lt;/term&gt;&lt;/term&gt;</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924542.9053')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924546.5386">@dollar@ node
...
<span class="hljs-meta prompt_">&gt;</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924546.5386')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924546.9187">mkdir -p myproject/src/main/typescript
mkdir -p myproject/src/test/typescript</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924546.9187')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924546.871">@dollar@ cd myproject
@dollar@ npm init
...

{
  ...
  &quot;author&quot;: &quot;Guillaume EHRET&quot;,
  &quot;license&quot;: &quot;MIT&quot;
}&lt;/pkg&gt;</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924546.871')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924547.322">npm install typescript</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924547.322')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1731527924547.124"><span class="hljs-attr">&quot;dependencies&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
  <span class="hljs-attr">&quot;typescript&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;^3.5.3&quot;</span>
<span class="hljs-punctuation">}</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924547.124')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924547.9014">npm install</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924547.9014')">Copy</button></pre>
</div>
</div>
</div>
</div>
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1731527924549.193"><span class="hljs-punctuation">{</span>
...
<span class="hljs-punctuation">}</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924549.193')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-typescript" id="1731527924550.065"><span class="hljs-title function_">great</span>(<span class="hljs-params">name: <span class="hljs-built_in">string</span></span>){
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924550.065')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-javascript" id="1731527924551.6355"><span class="hljs-variable language_">console</span>.<span class="hljs-title function_">log</span>(<span class="hljs-title function_">great</span>(<span class="hljs-number">123</span>));</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924551.6355')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-typescript" id="1731527924551.6348"><span class="hljs-keyword">let</span> age = <span class="hljs-number">42</span>;
age = <span class="hljs-string">&quot;inconnu&quot;</span>;</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924551.6348')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-typescript" id="1731527924553.5747"><span class="hljs-keyword">export</span> <span class="hljs-keyword">interface</span> <span class="hljs-title class_">Person</span> {
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924553.5747')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-typescript" id="1731527924555.422"><span class="hljs-keyword">import</span> {<span class="hljs-title class_">GreaterService</span>, <span class="hljs-title class_">Person</span>} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;./person&quot;</span>;
...
<span class="hljs-variable language_">console</span>.<span class="hljs-title function_">log</span>(<span class="hljs-keyword">new</span> <span class="hljs-title class_">GreaterService</span>().<span class="hljs-title function_">great</span>(person));</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924555.422')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924555.567">@dollar@ tsc
@dollar@ node build/index.js</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924555.567')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924555.6814">npm install jest @types/jest ts-jest -D</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924555.6814')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924555.1377">jest --init
...
📝  Configuration file created at /home/devmind/Workspace/web/dev-mind.fr/jest.config.js</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924555.1377')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1731527924556.2761"><span class="hljs-punctuation">[</span>source<span class="hljs-punctuation">,</span> shell<span class="hljs-punctuation">,</span> subs=<span class="hljs-string">&quot;none&quot;</span><span class="hljs-punctuation">]</span>
...
<span class="hljs-punctuation">}</span><span class="hljs-punctuation">,</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924556.2761')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1731527924556.9724"><span class="hljs-attr">&quot;scripts&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-punctuation">{</span>
  <span class="hljs-attr">&quot;test&quot;</span><span class="hljs-punctuation">:</span> <span class="hljs-string">&quot;jest&quot;</span>
<span class="hljs-punctuation">}</span><span class="hljs-punctuation">,</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924556.9724')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-typescript" id="1731527924559.0715"><span class="hljs-keyword">import</span> {<span class="hljs-title class_">GreaterService</span>, <span class="hljs-title class_">Person</span>} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;../../main/typescript/person&quot;</span>;
...
});</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924559.0715')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924559.9417">devmind@devmind:~/Workspace/web/myproject@dollar@ jest --coverage
...
Ran all test suites.</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924559.9417')">Copy</button></pre>
</div>
</div>
</div>
</div>
