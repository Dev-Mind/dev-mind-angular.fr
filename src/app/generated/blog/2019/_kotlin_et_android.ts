...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-kotlin" id="1731447062622.2844">s1 == s5   <span class="hljs-comment">// @ARROW renvoie true car Kotlin fait appel à la méthode equals</span>
s1 === s5  <span class="hljs-comment">// @ARROW renverra faux car === permet de comparer des références</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731447062622.2844')">Copy</button></pre>
</div>
</div>
</div>
<div class="sect2">
...
<span class="hljs-keyword">val</span> guillaume = speakers.firstOrNull(speaker <span class="hljs-meta">@LAMBDA</span> speaker.firstname == <span class="hljs-string">&quot;Guillaume&quot;</span>) <span class="hljs-comment">// ne compile pas</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731447062626.0718')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
}</code><button class="btn-copy-code" onclick="copyToClipboard('1731447062628.5024')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
