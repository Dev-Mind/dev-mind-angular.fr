...
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722604315718.0444">ng new my-ssr-app</code><button class="btn-copy-code" onclick="copyToClipboard('1722604315718.0444')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722604315718.9941">@dollar@ ng new my-ssr-app
? Which stylesheet format would you like to use? Sass (SCSS)     [
https://sass-lang.com/documentation/syntax#scss                ]
? Do you want to enable Server-Side Rendering (SSR) and Static Site Generation (SSG/Prerendering)?
(y/N)</code><button class="btn-copy-code" onclick="copyToClipboard('1722604315718.9941')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722604315718.9731">ng add @nguniversal/express-engine</code><button class="btn-copy-code" onclick="copyToClipboard('1722604315718.9731')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1722604315719.6675"><span class="hljs-punctuation">{</span>
  ...
  ...
<span class="hljs-punctuation">}</span></code><button class="btn-copy-code" onclick="copyToClipboard('1722604315719.6675')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722604315719.4856">npm run watch</code><button class="btn-copy-code" onclick="copyToClipboard('1722604315719.4856')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1722604315720.0332">npm run  serve:ssr:example</code><button class="btn-copy-code" onclick="copyToClipboard('1722604315720.0332')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
