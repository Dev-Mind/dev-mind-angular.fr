...
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924575.1465">ng new my-ssr-app</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924575.1465')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924575.137">@dollar@ ng new my-ssr-app
? Which stylesheet format would you like to use? Sass (SCSS)     [
https://sass-lang.com/documentation/syntax#scss                ]
? Do you want to enable Server-Side Rendering (SSR) and Static Site Generation (SSG/Prerendering)?
(y/N)</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924575.137')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924575.616">ng add @nguniversal/express-engine</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924575.616')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-json" id="1731527924576.9082"><span class="hljs-punctuation">{</span>
  ...
  ...
<span class="hljs-punctuation">}</span></code><button class="btn-copy-code" onclick="copyToClipboard('1731527924576.9082')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924576.2534">npm run watch</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924576.2534')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell" id="1731527924577.9504">npm run  serve:ssr:example</code><button class="btn-copy-code" onclick="copyToClipboard('1731527924577.9504')">Copy</button></pre>
</div>
</div>
<div class="paragraph">
