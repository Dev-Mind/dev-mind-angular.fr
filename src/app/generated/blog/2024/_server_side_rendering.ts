...
<ul class="sectlevel1">
<li><a href="@link@#_pourquoi_le_ssr">Pourquoi le SSR ?</a>
<ul class="sectlevel2">
<li><a href="@link@#_comment_fonctionne_le_ssr">Comment fonctionne le SSR ?</a></li>
<li><a href="@link@#_inconvénients_du_ssr">Inconvénients du SSR</a></li>
</ul>
</li>
<li><a href="@link@#_mettre_en_place_le_ssr_dans_une_application_angular">Mettre en place le SSR dans une application Angular</a>
<ul class="sectlevel2">
<li><a href="@link@#_comment_procéder">Comment procéder ?</a></li>
</ul>
</li>
...
<div class="content">
<pre class="highlight"><code class="language-shell">ng new my-ssr-app</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell">@dollar@ ng new my-ssr-app
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell">ng add @nguniversal/express-engine</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell">npm run watch</code></pre>
</div>
</div>
<div class="paragraph">
...
<div class="listingblock">
<div class="content">
<pre class="highlight"><code class="language-shell">npm run  serve:ssr:example</code></pre>
</div>
</div>
<div class="paragraph">
